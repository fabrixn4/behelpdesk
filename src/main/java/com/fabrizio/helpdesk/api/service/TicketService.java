package com.fabrizio.helpdesk.api.service;
...
public interface TicketService {
	...
	Page<Ticket> findByParameterAndAssigned(int page, int count, String title, String status, String priority, String assignedUser);
}
